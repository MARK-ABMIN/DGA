// Unified Custom Ajax Search JavaScript
jQuery(document).ready(function($) {
    ...
    const unifiedWrapper = $('.unified-search-wrapper');
    ...
    // Add visual feedback for unified input
    searchInput.on('focus', function() {
        unifiedWrapper.addClass('focused');
    });
    
    searchInput.on('blur', function() {
        unifiedWrapper.removeClass('focused');
    });
